...
def chat():
    try:
        ...
        # 1. NGOẠI LỆ: Tìm theo mã chính xác (Ưu tiên)
...
**Địa chỉ:** Thư viện Trường Đại học Hải Phòng (Tòa nhà A8).
🕒 **Giờ mở cửa:** Thứ 2 - Thứ 6: 7:30 - 17:00
🌐 **Website:** https://lib.dhhp.edu.vn
"""
